...
public class PinchTest : MonoBehaviour
{
    ...
    public bool activeRightPinch;
    public bool activeLeftPinch;
    public Vector3 pinchPointRight;
    public Vector3 pinchPointLeft;
    ...
    void Update()
    {
        ...
        if ((updateSuccessFlags & XRHandSubsystem.UpdateSuccessFlags.RightHandRootPose) != 0)
        {
            ...
            DetectPinch(m_RightIndexTipJoint, m_RightThumbTipJoint, ref activeRightPinch, true);
        }
        ...
        if ((updateSuccessFlags & XRHandSubsystem.UpdateSuccessFlags.LeftHandRootPose) != 0)
        {
            ...
            DetectPinch(m_LeftIndexTipJoint, m_LeftThumbTipJoint, ref activeLeftPinch, false);
        }
    }
    ...
    void DetectPinch(XRHandJoint index, XRHandJoint thumb, ref bool activeFlag, bool right)
    {
            ...
            thumb.trackingState != XRHandJointTrackingState.None)
        {
            ...
            if (pinchDistance <= m_ScaledThreshold)
            {
                ...
                if (right)
                {
                    pinchPointRight = indexPOS;
                }
                else
                {
                    pinchPointLeft = indexPOS;
                }
            }
            else
            {
